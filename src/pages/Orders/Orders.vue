    ...
    <div class="background-orders">
      ...
      <div class="pedidos-page-wrapper">
        <div class="pedidos-page-container">
          ...
          <p v-else-if="orders.length === 0" class="pedidos-vacio">
            No tienes pedidos todavía
          </p>

          <div v-else class="pedidos-lista">
            <div v-for="(pedido, index) in orders" :key="pedido.id" class="pedido-card">
              ...
              <div class="pedido-productos">
                <div v-for="(producto, i) in pedido.productos" :key="i" class="pedido-producto">
                  ...
                  <span class="pedido-producto-precio">{{ producto.precio }} €</span>
                </div>
              </div>

              <div v-if="pedido.envio" class="pedido-envio">
                <h4 class="pedido-envio-titulo">Información de envío</h4>
                <p class="pedido-envio-datos">
