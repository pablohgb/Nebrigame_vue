...
<template>
  ...
  <div class="page-wrapper">
          ...
          <div class="detalle">
            <div :class="`imagen-container imagen-container--${tipo}`">
              <img
                ...
                :alt="producto.nombre"
                :class="`imagen ${isFallback ? 'imagen--fallback' : ''}`"
            ...
            <div class="info">
              ...
              <div class="precio-row">
                ...
                <PlataformaDropdown
                  v-if="tipo === 'videojuegos' && plataformas && plataformas.length > 0"
              ...
              <div class="botones">
                <button
                  class="boton-wishlist"
                  @click="handleToggleWishlist(producto.id, producto.nombre)"
                ...
                <button v-else-if="stockDisponible > 0" class="boton-carrito" @click="handleAddToCart(producto.id, tipo === 'videojuegos' ? plataformaSeleccionada : null)" :disabled="isUpdating">
                  Añadir al carrito
                </button>
    ...
    <ConfirmModal
      ...
      :onClose="() => { showConfirmModal = false; productToDeleteModal = null }"
...
<style scoped>
  ...
  .page-wrapper {
    background-image: url("../../assets/images/background_productDetail.jpg");
  ...
  .imagen-container--videojuegos .imagen { object-fit: cover; }
  .imagen-container--videojuegos .imagen--fallback { object-fit: contain; }

  .info { display: flex; flex-direction: column; height: 100%; }
  .info h1 { color: white; font-size: 32px; margin-bottom: 16px; }
  ...
  .precio { color: white; font-size: 36px; font-weight: bold; margin: 0; }

  .botones { display: flex; gap: 16px; align-items: center; margin-top: auto; }
  ...
  .boton-wishlist:hover { background: #65319c; }
  ...
  .boton-carrito:hover { background: #65319c; }
  ...
  .seccion-descripcion h2 { color: white; font-size: 24px; margin-bottom: 16px; }
  .descripcion { color: white; font-size: 16px; line-height: 1.6; margin-bottom: 32px; }
  ...
  .dato { margin-bottom: 16px; display: flex; flex-direction: column; gap: 8px; }
  .etiqueta { color: rgba(255, 255, 255, 0.8); font-size: 14px; font-weight: 500; }
  .valor { color: white; font-size: 16px; font-weight: 600; }
  .lista-plataformas { display: flex; flex-wrap: wrap; gap: 8px; }
  ...
  @media (max-width: 768px) {
    .contenedor-detalle { padding: 16px; padding-top: 88px; }
    .detalle { grid-template-columns: 1fr; }
    .precio-row { flex-direction: column; align-items: flex-start; }
    .especificaciones { grid-template-columns: 1fr; }
    .botones { flex-direction: column; }
    .boton-wishlist, .boton-carrito, .boton-aviso-reposicion { width: 100%; }
  }
